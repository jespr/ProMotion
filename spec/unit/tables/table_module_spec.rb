...
describe "PM::Table module" do
  ...
  before do
    ...
    @subject.mock! :table_data do
      [{
        ...
        title: "Custom section title 1", title_view: MyCustomCell, cells: [ ]
      },{
        title: "Custom section title 2", title_view: MyCustomCell, title_view_height: 50, cells: [ ]
      }]
    end
  ...
  it "should have the right number of sections" do
    @subject.numberOfSectionsInTableView(@subject.table_view).should == 5
  end
  ...
  it "should set the section titles" do
    ...
    @subject.tableView(@subject.table_view, titleForHeaderInSection:4).should == "Custom section title 2"
  end
  ...
  it "should have nil as view for header in section" do
    cell = @subject.tableView(@subject.table_view, viewForHeaderInSection: 3)
    cell.should.be.nil
  end
  ...
  describe("section with custom title_view") do
    ...
    it "should use the correct class for section view" do
      ...
      cell.should.be.kind_of(MyCustomCell)
    end
